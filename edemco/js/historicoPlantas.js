            ...
            success: function (data) {
                ...
                // Verifica si la fecha contiene el año seleccionado
                    if (cliente.id === parseInt(clienteId) && cliente.fecha.startsWith(selectedYear)) {
                        ...
                        row.append($("<td>").text(cliente.monthly_energy + " kWh"));
                        row.append($("<td>").text(cliente.acumulado_monthly_energy + " kWh"));
                        row.append($("<td>").text(cliente.valor_kwh));
                        row.append($("<td>").text(cliente.valor_total));
                        ...
                        row.append($("<td>").text(cliente.acumulado_c02));
